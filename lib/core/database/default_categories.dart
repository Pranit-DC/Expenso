  ...
  static List<CategoryModel> _buildDefaults() {
    return [
      ...
      CategoryModel(
        id: 'cat_travel',
        name: 'Travel',
        iconCodePoint: PhosphorIconsFill.airplane.codePoint,
        colorHex: '03A9F4',
        type: 0,
        isDefault: true,
      ),
      ...
      CategoryModel(
        ...
        name: 'Subscriptions',
        iconCodePoint: PhosphorIconsFill.creditCard.codePoint,
        colorHex: '673AB7',
        type: 0,
        isDefault: true,
      ),
      ...
      CategoryModel(
        ...
        name: 'Personal Care',
        iconCodePoint: PhosphorIconsFill.sparkle.codePoint,
        colorHex: '009688',
        type: 0,
        isDefault: true,
      ),
      ...
      CategoryModel(
        id: 'cat_maintenance',
        name: 'Maintenance',
        iconCodePoint: PhosphorIconsFill.wrench.codePoint,
        colorHex: '607D8B',
        type: 0,
        isDefault: true,
      ),
      CategoryModel(
        id: 'cat_insurance',
        name: 'Insurance',
        iconCodePoint: PhosphorIconsFill.shieldCheck.codePoint,
        colorHex: '455A64',
        type: 0,
        isDefault: true,
      ),
      ...
      CategoryModel(
        id: 'cat_bonus',
        name: 'Bonus',
        iconCodePoint: PhosphorIconsFill.coins.codePoint,
        colorHex: 'FFC107',
        type: 1,
        isDefault: true,
      ),
      ...
      CategoryModel(
        id: 'cat_savings_income',
        name: 'Savings',
        iconCodePoint: PhosphorIconsFill.bank.codePoint,
        colorHex: '009688',
        type: 1,
        isDefault: true,
      ),
